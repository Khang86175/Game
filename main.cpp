...
public:
    ...
    MyTank(float x, float y, float size,float mapsize):body(x,y,mapsize,size,100, 0.2f, 2),score(0),level(1), xp_base(0), xp_to_lv_up(100), tankType(0), tankTwin(nullptr), statPoint(0){
